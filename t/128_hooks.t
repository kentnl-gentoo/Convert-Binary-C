...
$SIG{__WARN__} = sub { $_[0] =~ /^(?:add|delete(?:_all)?)_hooks\(\) is deprecated/
                                or die "unexpected warning: $_[0]" };
...
####### new hooks implementation using tags #######
